...
#ifndef DYNAMIXEL_RDK_MSGS__MSG__DYNAMIXEL_STATUS_MSGS_H_
#define DYNAMIXEL_RDK_MSGS__MSG__DYNAMIXEL_STATUS_MSGS_H_
...
#endif  // DYNAMIXEL_RDK_MSGS__MSG__DYNAMIXEL_STATUS_MSGS_H_
