...
class Metaclass_DynamixelMsgs(type):
    """Metaclass of message 'DynamixelMsgs'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__dynamixel_msgs
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__dynamixel_msgs
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__dynamixel_msgs
            cls._TYPE_SUPPORT = module.type_support_msg__msg__dynamixel_msgs
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__dynamixel_msgs
...
class DynamixelMsgs(metaclass=Metaclass_DynamixelMsgs):
    """Message class 'DynamixelMsgs'."""
    ...
    def __init__(self, **kwargs):
        ...
        self.profile_acceleration = kwargs.get('profile_acceleration', float())
        self.profile_velocity = kwargs.get('profile_velocity', float())
    ...
    def profile_acceleration(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'profile_acceleration' field must be of type 'float'"
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'profile_acceleration' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
    ...
    def profile_velocity(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'profile_velocity' field must be of type 'float'"
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'profile_velocity' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
