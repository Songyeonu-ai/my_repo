...
#include "dynamixel_rdk_msgs/msg/detail/dynamixel_status_msgs__rosidl_typesupport_fastrtps_c.h"
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPORT_dynamixel_rdk_msgs
...
using _DynamixelStatusMsgs__ros_msg_type = dynamixel_rdk_msgs__msg__DynamixelStatusMsgs;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _DynamixelStatusMsgs__ros_msg_type * ros_message = static_cast<const _DynamixelStatusMsgs__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
  ...
  // Field name: present_acceleration
  {
  ...
  // Field name: min_max_position
  {
    size_t size = 2;
    auto array_ptr = ros_message->min_max_position;
  ...
  void * untyped_ros_message)
{
  ...
  _DynamixelStatusMsgs__ros_msg_type * ros_message = static_cast<_DynamixelStatusMsgs__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
static uint32_t _DynamixelStatusMsgs__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_dynamixel_rdk_msgs__msg__DynamixelStatusMsgs(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = dynamixel_rdk_msgs__msg__DynamixelStatusMsgs;
    is_plain =
      (
...
static size_t _DynamixelStatusMsgs__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_dynamixel_rdk_msgs__msg__DynamixelStatusMsgs(
...
static message_type_support_callbacks_t __callbacks_DynamixelStatusMsgs = {
...
static rosidl_message_type_support_t _DynamixelStatusMsgs__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_DynamixelStatusMsgs,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dynamixel_rdk_msgs, msg, DynamixelStatusMsgs)() {
  return &_DynamixelStatusMsgs__type_support;
}
