...
bool humanoid_interfaces__msg__robocupcontroller__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("humanoid_interfaces.msg._robocupcontroller.Robocupcontroller", full_classname_dest, 60) == 0);
  }
  humanoid_interfaces__msg__Robocupcontroller * ros_message = _ros_message;
  {  // robotnum
  ...
  {  // firsthalf
    PyObject * field = PyObject_GetAttrString(_pymsg, "firsthalf");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->firsthalf = PyLong_AsLongLong(field);
    Py_DECREF(field);
  }
  {  // firstside
    PyObject * field = PyObject_GetAttrString(_pymsg, "firstside");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->firstside = PyLong_AsLongLong(field);
    Py_DECREF(field);
  }
  {  // kickoffteam
    PyObject * field = PyObject_GetAttrString(_pymsg, "kickoffteam");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->kickoffteam = PyLong_AsLongLong(field);
    Py_DECREF(field);
  }
  {  // secondstate
...
{
  /* NOTE(esteve): Call constructor of Robocupcontroller */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("humanoid_interfaces.msg._robocupcontroller");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Robocupcontroller");
  ...
  {  // firsthalf
    PyObject * field = NULL;
    field = PyLong_FromLongLong(ros_message->firsthalf);
    {
      int rc = PyObject_SetAttrString(_pymessage, "firsthalf", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // firstside
    PyObject * field = NULL;
    field = PyLong_FromLongLong(ros_message->firstside);
    {
      int rc = PyObject_SetAttrString(_pymessage, "firstside", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // kickoffteam
    PyObject * field = NULL;
    field = PyLong_FromLongLong(ros_message->kickoffteam);
    {
      int rc = PyObject_SetAttrString(_pymessage, "kickoffteam", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
