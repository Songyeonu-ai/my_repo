...
#include "humanoid_interfaces/msg/detail/gamecontroldata__rosidl_typesupport_fastrtps_c.h"
...
using _Gamecontroldata__ros_msg_type = humanoid_interfaces__msg__Gamecontroldata;
...
size_t get_serialized_size_humanoid_interfaces__msg__Gamecontroldata(
  const void * untyped_ros_message,
...
static uint32_t _Gamecontroldata__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_humanoid_interfaces__msg__Gamecontroldata(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_humanoid_interfaces
size_t max_serialized_size_humanoid_interfaces__msg__Gamecontroldata(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = humanoid_interfaces__msg__Gamecontroldata;
    is_plain =
      (
...
static size_t _Gamecontroldata__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_humanoid_interfaces__msg__Gamecontroldata(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, humanoid_interfaces, msg, Gamecontroldata)() {
