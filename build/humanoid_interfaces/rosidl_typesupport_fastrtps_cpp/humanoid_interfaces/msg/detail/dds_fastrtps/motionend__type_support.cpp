...
#include "humanoid_interfaces/msg/detail/motionend__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const humanoid_interfaces::msg::Motionend & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  humanoid_interfaces::msg::Motionend & ros_message)
{
  // Member: motionend
  cdr >> ros_message.motionend;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = humanoid_interfaces::msg::Motionend;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const humanoid_interfaces::msg::Motionend *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<humanoid_interfaces::msg::Motionend *>(
    untyped_ros_message);
...
{
  return &humanoid_interfaces::msg::typesupport_fastrtps_cpp::_Motionend__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, humanoid_interfaces, msg, Motionend)() {
  return &humanoid_interfaces::msg::typesupport_fastrtps_cpp::_Motionend__handle;
}
