...
#include "humanoid_interfaces/msg/detail/ik_pattern_msg__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const humanoid_interfaces::msg::IkPatternMsg & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  humanoid_interfaces::msg::IkPatternMsg & ros_message)
{
  // Member: xlpattern
  cdr >> ros_message.xlpattern;
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_humanoid_interfaces
max_serialized_size_IkPatternMsg(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = humanoid_interfaces::msg::IkPatternMsg;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const humanoid_interfaces::msg::IkPatternMsg *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<humanoid_interfaces::msg::IkPatternMsg *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _IkPatternMsg__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const humanoid_interfaces::msg::IkPatternMsg *>(
...
static size_t _IkPatternMsg__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_IkPatternMsg(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _IkPatternMsg__callbacks = {
...
static rosidl_message_type_support_t _IkPatternMsg__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_IkPatternMsg__callbacks,
...
{
  return &humanoid_interfaces::msg::typesupport_fastrtps_cpp::_IkPatternMsg__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, humanoid_interfaces, msg, IkPatternMsg)() {
  return &humanoid_interfaces::msg::typesupport_fastrtps_cpp::_IkPatternMsg__handle;
}
