...
bool humanoid_interfaces__msg__motor_msg__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("humanoid_interfaces.msg._motor_msg.MotorMsg", full_classname_dest, 43) == 0);
  }
  humanoid_interfaces__msg__MotorMsg * ros_message = _ros_message;
  {  // length
  ...
  {  // speed
    ...
    if (PyObject_CheckBuffer(field)) {
      ...
      int32_t * dest = ros_message->speed.data;
      rc = PyBuffer_ToContiguous(dest, &view, view.len, 'C');
      if (rc < 0) {
        PyBuffer_Release(&view);
        Py_DECREF(field);
  ...
  {  // type
    ...
    if (PyObject_CheckBuffer(field)) {
      ...
      int32_t * dest = ros_message->type.data;
      rc = PyBuffer_ToContiguous(dest, &view, view.len, 'C');
      if (rc < 0) {
        PyBuffer_Release(&view);
        Py_DECREF(field);
  ...
  {  // acceleration
    ...
    if (PyObject_CheckBuffer(field)) {
      ...
      int32_t * dest = ros_message->acceleration.data;
      rc = PyBuffer_ToContiguous(dest, &view, view.len, 'C');
      if (rc < 0) {
        PyBuffer_Release(&view);
        Py_DECREF(field);
...
{
  /* NOTE(esteve): Call constructor of MotorMsg */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("humanoid_interfaces.msg._motor_msg");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "MotorMsg");
  ...
  {  // speed
    ...
    if (ros_message->speed.size > 0) {
      ...
      PyObject * frombytes = PyObject_GetAttrString(field, "frombytes");
      assert(frombytes != NULL);
      int32_t * src = &(ros_message->speed.data[0]);
      PyObject * data = PyBytes_FromStringAndSize((const char *)src, ros_message->speed.size * sizeof(int32_t));
      assert(data != NULL);
      PyObject * ret = PyObject_CallFunctionObjArgs(frombytes, data, NULL);
      Py_DECREF(data);
      Py_DECREF(frombytes);
  ...
  {  // type
    ...
    if (ros_message->type.size > 0) {
      ...
      PyObject * frombytes = PyObject_GetAttrString(field, "frombytes");
      assert(frombytes != NULL);
      int32_t * src = &(ros_message->type.data[0]);
      PyObject * data = PyBytes_FromStringAndSize((const char *)src, ros_message->type.size * sizeof(int32_t));
      assert(data != NULL);
      PyObject * ret = PyObject_CallFunctionObjArgs(frombytes, data, NULL);
      Py_DECREF(data);
      Py_DECREF(frombytes);
  ...
  {  // acceleration
    ...
    if (ros_message->acceleration.size > 0) {
      ...
      PyObject * frombytes = PyObject_GetAttrString(field, "frombytes");
      assert(frombytes != NULL);
      int32_t * src = &(ros_message->acceleration.data[0]);
      PyObject * data = PyBytes_FromStringAndSize((const char *)src, ros_message->acceleration.size * sizeof(int32_t));
      assert(data != NULL);
      PyObject * ret = PyObject_CallFunctionObjArgs(frombytes, data, NULL);
      Py_DECREF(data);
      Py_DECREF(frombytes);
