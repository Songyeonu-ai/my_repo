...
bool humanoid_interfaces__msg__pidtuning__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("humanoid_interfaces.msg._pidtuning.Pidtuning", full_classname_dest, 44) == 0);
  }
  humanoid_interfaces__msg__Pidtuning * ros_message = _ros_message;
  {  // kp
...
{
  /* NOTE(esteve): Call constructor of Pidtuning */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("humanoid_interfaces.msg._pidtuning");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Pidtuning");
