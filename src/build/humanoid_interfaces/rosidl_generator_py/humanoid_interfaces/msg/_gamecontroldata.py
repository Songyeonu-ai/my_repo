    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'humanoid_interfaces.msg.Gamecontroldata')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__gamecontroldata
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__gamecontroldata
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__gamecontroldata
            cls._TYPE_SUPPORT = module.type_support_msg__msg__gamecontroldata
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__gamecontroldata
...
class Gamecontroldata(metaclass=Metaclass_Gamecontroldata):
    ...
    def __init__(self, **kwargs):
        ...
        self.myside = kwargs.get('myside', int())
        self.iskickoff = kwargs.get('iskickoff', int())
    ...
    def __eq__(self, other):
        ...
        if self.state != other.state:
            return False
        if self.myside != other.myside:
            return False
        if self.iskickoff != other.iskickoff:
            return False
    ...
    @builtins.property
    def myside(self):
        """Message field 'myside'."""
        return self._myside

    @myside.setter
    def myside(self, value):
        if __debug__:
            assert \
                isinstance(value, int), \
                "The 'myside' field must be of type 'int'"
            assert value >= -9223372036854775808 and value < 9223372036854775808, \
                "The 'myside' field must be an integer in [-9223372036854775808, 9223372036854775807]"
        self._myside = value

    @builtins.property
    def iskickoff(self):
        """Message field 'iskickoff'."""
        return self._iskickoff

    @iskickoff.setter
    def iskickoff(self, value):
        if __debug__:
            assert \
                isinstance(value, int), \
                "The 'iskickoff' field must be of type 'int'"
            assert value >= -9223372036854775808 and value < 9223372036854775808, \
                "The 'iskickoff' field must be an integer in [-9223372036854775808, 9223372036854775807]"
        self._iskickoff = value
