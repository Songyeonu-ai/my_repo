...
static const _Robocuplocalization25_type_support_symbol_names_t _Robocuplocalization25_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, humanoid_interfaces, msg, Robocuplocalization25)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, humanoid_interfaces, msg, Robocuplocalization25)),
  }
};
...
{
  return &::humanoid_interfaces::msg::rosidl_typesupport_cpp::Robocuplocalization25_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, humanoid_interfaces, msg, Robocuplocalization25)() {
  return get_message_type_support_handle<humanoid_interfaces::msg::Robocuplocalization25>();
}
